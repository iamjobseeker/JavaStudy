...
public class Addschedule_Null extends JFrame { 
	...
	protected Addschedule_Null() { // 생성자 
		setTitle("일정 등록"); // 타이틀 
...
//		start.setFont(new Font("굴림", Font.PLAIN, 15)); // 폰트 지정
		...
		start.setForeground(Color.GRAY); // 초기 텍스트 색상 
		start.setBorder(null); // 외곽선 투명 
...
//		anny2.setForeground(new Color(255, 182, 193));
		...
		nobut.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// 확인 및 취소 버튼
				JButton c_okbut = new JButton("확인"); // 취소하기 확인(cancel_ok)
				c_okbut.setBounds(30, 90, 70, 40);
				JButton c_nobut = new JButton("취소"); // 취소하지 않기(cancel_cancel)
		...
		okbut.requestFocus(); // 등록 버튼이 포커스 획득 
	} 
